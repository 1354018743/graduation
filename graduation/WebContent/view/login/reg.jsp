...
<body>
  <div class="reg_div">
    <p>注册</p>
    <ul class="reg_ul">
    <li>我们会将你的信息进行核对以及本人确定，通过后将可以登录本系统</li>
      <li>
          <span>真实姓名：</span>
      ...
      <li>
          <span>所在学院：</span>
          <input type="text" name="truename" value="" placeholder="输入所在学院" class="reg_depature">
  ...
  <script type="text/javascript" src="/graduation/js/jquery.min.js"> </script>
  ...
  $('.red_button').click(function(){
    if(user_Boolean && stuno_Boolean && depature_Boolean && emaile_Boolean && class_Boolean == true){
      alert("正在提交");
		...
		$.post("/graduation/user/reg",{name:a,email:b,stuno:c,
			sex:d,depature:e,grade:g},function(data){
