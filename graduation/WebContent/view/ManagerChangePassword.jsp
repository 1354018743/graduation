...
<title>Insert title here</title>
	...
	<script type="text/javascript" src="/airlineTickets/easyui/jqeruy.md5.js"></script>
</head>
<body>
	<div id="win">
		    ...
		    function changePassword(){
		    	...
		    	var passwordagain=$('#passwordagain').val();
		    	 ...
		    	 if(newpassword!=passwordagain){
		    		 ...
		    		 $.post('/airlineTickets/ChangePassword/ManagerChangePassword',{oldpassword:oldpassword,passwordagain:passwordagain},function(data){
							if(data=='true'){
